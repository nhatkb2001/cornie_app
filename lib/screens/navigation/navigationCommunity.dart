...
class NavigationCommunity extends StatefulWidget {
  NavigationCommunity({super.key, required this.userId});
  String userId;

  @override
  State<NavigationCommunity> createState() => _NavigationCommunityState();
}

class _NavigationCommunityState extends State<NavigationCommunity> {
  int valueChoose = 1;
